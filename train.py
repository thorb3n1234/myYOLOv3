...
parser.add_argument("--image_folder", type=str, default="../daten/ML_DATA/data/data/train/", help="path to dataset")
...
parser.add_argument("--class_path", type=str, default="config/obj.names", help="path to class label file")
...
parser.add_argument("--checkpoint_dir", type=str, default="backup", help="directory where model checkpoints are saved")
...
hyperparams = parse_cfg(opt.model_config_path)[0]
